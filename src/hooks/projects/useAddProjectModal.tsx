...
import type { DataProjectType } from "../../types/interface";
import { useState } from "react";
import { CreateProjectAction } from "@/serverActions/CreateProjectAction";
import { editProjectAction } from "@/serverActions/EditProjectAction";
...
export const useAddProjectModal = ({ onSuccess, closeModal, projectID }: ModalProps) =>{
      ...
      const creaProyecto = async(e: React.FormEvent<HTMLFormElement>) =>{
        ...
        const dataProject: DataProjectType = {
        ...
        try{
          ...
          const {success, error} = projectID ? await editProjectAction({projectID, dataProject}) : await CreateProjectAction(dataProject)
