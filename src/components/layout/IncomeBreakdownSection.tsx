...
export const IncomeBreakdownSection = ({children}: LayoutProps) =>{
            ...
            <h2 className="text-primary font-bold text-[18px] mb-4">Income Breakdown</h2>
                <div className="flex flex-col gap-3">
                    ...
                    <div className="flex gap-1.5 p-5 items-center bg-[#161f32]">
                        ...
                        <p className="text-secundary text-[16px] font-semibold">Next payout scheduled for <span className="text-primary text-[14px] font-bold">Oct 15th</span></p>  
                    </div>      
